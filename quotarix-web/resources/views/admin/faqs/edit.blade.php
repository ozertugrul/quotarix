...
<div class="mb-4">
    ...
    <h2 class="fw-bold text-navy mt-1">Soru & Cevap Düzenle</h2>
</div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm p-4" style="border-radius: 20px; background: #fff;">
                <div class="mb-3">
                    ...
                    <input type="text" name="question" class="form-control" value="{{ old('question', $faq->question) }}" required style="border-radius: 10px; padding: 11px 14px;">
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold small text-navy">Cevap <span class="text-danger">*</span></label>
                    <textarea name="answer" class="form-control" rows="5" required style="border-radius: 10px; padding: 11px 14px;">{{ old('answer', $faq->answer) }}</textarea>
                </div>

                <div class="mb-4">
                    <label class="form-label fw-bold small text-navy">Sıralama</label>
                    <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', $faq->sort_order) }}" style="border-radius: 10px; padding: 11px 14px; max-width: 150px;">
                </div>
