...
## Corpus Check
- 64 files · ~108,963 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 333 nodes · 499 edges · 29 communities (24 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92b47cfa`
...
3. `Post` - 14 edges
4. `Video` - 13 edges
5. `Quotarix Landing Page (index.html)` - 13 edges
6. `Faq` - 12 edges
7. `ContentSeeder` - 12 edges
8. `Plan` - 10 edges
9. `Controller` - 9 edges
10. `Lead` - 9 edges
...
Cohesion: 0.08
Nodes (16): Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Database\Seeder, Illuminate\Support\Facades\Hash, Illuminate\Support\Str, Pdo\Mysql, active_sections(), is_section_active(), setting() (+8 more)
...
Cohesion: 0.25
Nodes (7): Closure, Illuminate\Foundation\Application, Illuminate\Foundation\Configuration\Exceptions, Illuminate\Foundation\Configuration\Middleware, Illuminate\Http\Request, RedirectLegacyHtml, Symfony\Component\HttpFoundation\Response
...
### Community 20 - "Page"
Cohesion: 0.09
Nodes (18): Carbon\Carbon, Illuminate\Http\RedirectResponse, Illuminate\Http\Response, Illuminate\Support\Facades\Route, Illuminate\View\View, BlogController, Controller, FaqController (+10 more)

### Community 31 - "Illuminate\Database\Eloquent\Factories\HasFactory"
Cohesion: 0.08
Nodes (13): Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Attributes\Hidden, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Model, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Illuminate\Support\Facades\Cache, Admin (+5 more)

### Community 32 - "ContentSeeder"
Cohesion: 0.13
Nodes (7): Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, ContentSeeder, SectionSeeder, ExampleTest, RouteTest, TestCase
...
- **Why does `ContentSeeder` connect `ContentSeeder` to `Page`, `Illuminate\Database\Seeder`?**
